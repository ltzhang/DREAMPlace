# WIP SCAFFOLD — GangSTA timer backend, NOT yet functional. Mechanical rename of
# timing_heterosta; see README.md in this directory for the remaining seams. Not built
# (unregistered in ops/CMakeLists.txt) until validated on an ICCAD-2015 design.
import torch
...
class TimingOpt(nn.Module):
    ...
    def dump_paths_setup_to_file(self, num_paths, nworst, file_path, use_cuda=False):
        """
        @brief dump timing paths to file using GangSTA
