...
class TimingGangstaIO {
public:
    // RAII wrapper for GangstaTimer with custom deleter
    using GangstaTimerPtr = std::unique_ptr<GangstaTimer, void(*)(GangstaTimer*)>;
    ...
    ///
    static bool setupTiming(GangstaTimer& sta, PlaceDB& placedb, int argc, char** argv, 
    ...
    /// @return unique pointer to GangstaTimer with RAII management
    ///
    static GangstaTimerPtr initialize_heterosta();
    ...
    /// @return true if successful, false otherwise
    ///
    static bool read_liberty_libraries(GangstaTimer& sta, int argc, char** argv);
    ...
    /// @return true if successful, false otherwise
    ///
    static bool read_sdc_constraints_with_path(GangstaTimer& sta, const std::string& sdc_path);
    ...
    /// @return true if successful, false otherwise
    ///
    static bool read_liberty_libraries_with_paths(GangstaTimer& sta, 
